...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiRfidSample.MVVM.Mode.FirmwareUpdateModel, MauiRfidSample", FirmwareUpdateModel.class, __md_methods);
	}

	public FirmwareUpdateModel ()
	{
		super ();
		if (getClass () == FirmwareUpdateModel.class) {
			mono.android.TypeManager.Activate ("MauiRfidSample.MVVM.Mode.FirmwareUpdateModel, MauiRfidSample", "", this, new java.lang.Object[] {  });
		}
	}
