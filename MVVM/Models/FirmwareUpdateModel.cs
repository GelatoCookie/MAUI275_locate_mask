...
namespace MauiRfidSample.MVVM.Mode
{
    class FirmwareUpdateModel: Java.Lang.Object, IDcsSdkApiDelegate
    {
        ...
        // Use ScannerModel.cs file instead of FirmwareUpdateModel.cs to handle DcssdkEventFirmwareUpdate events
        public void DcssdkEventFirmwareUpdate(FirmwareUpdateEvent firmwareUpdateEvent)
        {

            if (firmwareUpdateEvent.EventType == DCSSDKDefs.DCSSDK_FU_EVENT_TYPE.ScannerUfDlStart)
            {
                System.Diagnostics.Debug.WriteLine("ScannerControl Update Firmware Session Started! FirmwareUpdateModel ");
            }
