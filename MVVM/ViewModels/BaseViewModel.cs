...
namespace MauiRfidSample.MVVM.ViewModels
{
    public class BaseViewModel : INotifyPropertyChanged
	{
        ...
        public virtual void CurrentProgressUpdate(IEvents.FirmwareUpdateEvent currentProgress)
        {
        ...
        {
            rfidModel.UpdateFirmwareProgressResult += CurrentProgressUpdate;
        ...
        public virtual void IotMgmtStatusEvent(IEvents.IotEventMgmt statusEvent)
        {

        }

        public virtual void IotMgmtEvtStatusEvent(IEvents.IotEventMgmtEvt statusEvent)
        {

        }

        public virtual void IotControlStatusEvent(IEvents.IotEventControl statusEvent)
        {

        }

        public virtual void IotData1StatusEvent(IEvents.IotEventData1 statusEvent)
        {

        }

        public virtual void IotData2StatusEvent(IEvents.IotEventData2 statusEvent)
        {

        }

        public virtual void CertificateEvent(IEvents.CertificateEventData statusEvent)
        {

        }

        internal void UpdateEndpointStatusEventsIn()
        {
            rfidModel.IotEventMgmt += IotMgmtStatusEvent;
            rfidModel.IotEventMgmtEvt += IotMgmtEvtStatusEvent;
            rfidModel.IotEventControl += IotControlStatusEvent;
            rfidModel.IotEventData1 += IotData1StatusEvent;
            rfidModel.IotEventData2 += IotData2StatusEvent;
            
        }
        internal void UpdateEndpointStatusEventsOut()
        {
            rfidModel.IotEventMgmt -= IotMgmtStatusEvent;
            rfidModel.IotEventMgmtEvt -= IotMgmtEvtStatusEvent;
            rfidModel.IotEventControl -= IotControlStatusEvent;
        ...
        internal void UpdateCertificateEventsIn()
        {
            rfidModel.CertificateEvent += CertificateEvent;
        }
        internal void UpdateCertificateEventsOut()
        {
            rfidModel.CertificateEvent -= CertificateEvent;
        }
    }
